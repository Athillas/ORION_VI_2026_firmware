...
namespace NetworkConfig
{
    ...
    constexpr uint8_t MAC[6]                        = { 0xDE, 0xAD, 0xBE, 0xEF, 0xFE, 0xE6 };
    constexpr uint8_t IP[4]                         = { 192, 168, 1, 56 };
    ...
    constexpr const char* const TOPIC_ENC           = "Power_control_enc";
    constexpr const char* const TOPIC_CMD           = "Power_control_cmd";
