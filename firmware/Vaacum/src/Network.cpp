...
inline static uint8_t MAC_[6]; // non-const local copy, needed because of Ethernet's begin limitations.
inline static uint8_t IP_[4]; // same as ^
...
*/
inline static struct NetworkState *ns_ = nullptr;
inline static struct HardwareCommandState *hcs_ = nullptr;
